...
La plateforme fonctionne avec des notifications internes ; pensez à consulter régulièrement vos notifications.

Des Conditions d'utilisation plus complètes précisent le fonctionnement de la plateforme et les responsabilités de chacun. En créant votre compte, vous devez également les accepter.

## Acceptation

Lors de l'inscription :

« J'ai lu et accepté les règles de fonctionnement de la plateforme. »
