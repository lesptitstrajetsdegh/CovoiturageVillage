export default function Rules() {
  return (
    <main className="legal-page">
      <h1>Règles de fonctionnement — Les P'tits trajets de Grand-Hallet</h1>
      ...
      <p>En utilisant la plateforme, je m'engage à :</p>
      ...
      <p>
        ...
        chaque trajet et chaque arrangement restent de la responsabilité des
        parents concernés.
      </p>

      <p>
        La plateforme fonctionne avec des notifications internes ; pensez à
        consulter régulièrement vos notifications.
      </p>

      <p>
        Des Conditions d'utilisation plus complètes précisent le fonctionnement
        de la plateforme et les responsabilités de chacun. En créant votre
        compte, vous devez également les accepter.
      </p>
